...
namespace CivicaEmployeeMaster.Data.Implementation
{
    public class EmployeeRepository: IEmployeeRepository
    {
        ...
        public IEnumerable<SalaryHeadTotalByStoreProcedure> GetTotalSalaryByYearByStoreProcedure(int year)
        {
            var totals = _appDbContext.GetEmployeeYearlySalarySlip(year);
            return totals;
        }
        ...
        public IEnumerable<SalaryHeadTotalByStoreProcedure> GetTotalSalaryByMonthByStoreProcedure(int month, int year)
        {


            var totals = _appDbContext.GetTotalSalaryByMonth(month,year);
        ...
        public IEnumerable<SalaryHeadTotalByStoreProcedure> GetTotalSalaryByMonthYearAndIdByStoreProcedure(int employeeId, int month, int year)
        {

            var totals = _appDbContext.GetEachEmpSalaryByMonth(employeeId,month,year);
        ...
        public IEnumerable<SalaryHeadTotalByStoreProcedure> GetTotalSalaryByYearAndIdByStoreProcedure(int employeeId, int year)
        {
            var employee = _appDbContext.Employees.FirstOrDefault(e => e.Id == employeeId);
            ...
            {
                // Handle case where employee with given ID is not found
                return Enumerable.Empty<SalaryHeadTotalByStoreProcedure>();
            }

            var totals = _appDbContext.GetEachEmployeeYearlySalarySlip(employeeId, year);
