...
namespace CivicaEmployeeMaster.Services.Implementation
{
    public class EmployeeService : IEmployeeService
    {
        ...
        public ServiceResponse<IEnumerable<SalaryHeadTotalByStoreProcedure>> GetTotalSalaryByYearByStoreProcedure(int year)
        {
            var response = new ServiceResponse<IEnumerable<SalaryHeadTotalByStoreProcedure>>();
            ...
            try
            {
                ...
                {
                    response.Success = false;
                    response.Message = "Please select a valid year";
                    return response;
                }

                var totals = _employeeeRepository.GetTotalSalaryByYearByStoreProcedure(year);

                if (totals != null && totals.Any())
                {
                    List<SalaryHeadTotalByStoreProcedure> salaryHeadTotals = new List<SalaryHeadTotalByStoreProcedure>();
                    foreach (var t in totals)
                    {
                        salaryHeadTotals.Add(new SalaryHeadTotalByStoreProcedure()
                        {
                            Month = t.Month,
                            Year = t.Year,
                            TotalSalary = t.TotalSalary,
        ...
        public ServiceResponse<IEnumerable<SalaryHeadTotalByStoreProcedure>> GetTotalSalaryByMonthByStoreProcedure(int month, int year)
        {
            var response = new ServiceResponse<IEnumerable<SalaryHeadTotalByStoreProcedure>>();
            if (year > DateTime.Now.Year || (year == DateTime.Now.Year && month > DateTime.Now.Month))
            {
            ...
            try
            {
                var totals = _employeeeRepository.GetTotalSalaryByMonthByStoreProcedure(month, year);
        ...
        public ServiceResponse<IEnumerable<SalaryHeadTotalByStoreProcedure>> GetTotalSalaryByMonthYearAndIdByStoreProcedure(int employeeId, int month, int year)
        {
            var response = new ServiceResponse<IEnumerable<SalaryHeadTotalByStoreProcedure>>();
            ...
            try
            {
                var totals = _employeeeRepository.GetTotalSalaryByMonthYearAndIdByStoreProcedure(employeeId, month, year);
        ...
        public ServiceResponse<IEnumerable<SalaryHeadTotalByStoreProcedure>> GetTotalSalaryByYearAndIdByStoreProcedure(int employeeId, int year)
        {
            var response = new ServiceResponse<IEnumerable<SalaryHeadTotalByStoreProcedure>>();
            ...
            try
            {
                ...
                var totals = _employeeeRepository.GetTotalSalaryByYearAndIdByStoreProcedure(employeeId, year);
