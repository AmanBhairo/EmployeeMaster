...
namespace CivicaEmployeeMaster.Services.Contract
{
    public interface IEmployeeService
    {
        ...
        ServiceResponse<IEnumerable<SalaryHeadTotalByStoreProcedure>> GetTotalSalaryByYearByStoreProcedure(int year);
        ServiceResponse<IEnumerable<SalaryHeadTotal>> GetTotalSalaryByMonth(int month, int year);
        ServiceResponse<IEnumerable<SalaryHeadTotalByStoreProcedure>> GetTotalSalaryByMonthByStoreProcedure(int month, int year);
        ...
        ServiceResponse<IEnumerable<SalaryHeadTotalByStoreProcedure>> GetTotalSalaryByMonthYearAndIdByStoreProcedure(int employeeId, int month, int year);
        ServiceResponse<IEnumerable<SalaryHeadTotal>> GetTotalSalaryByYearAndId(int employeeId, int year);
        ServiceResponse<IEnumerable<SalaryHeadTotalByStoreProcedure>> GetTotalSalaryByYearAndIdByStoreProcedure(int employeeId, int year);
